...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8 col-md-8 col-sm-9 col-8">
                    <div class="headbar">
                        <a class="head-bar1" href="#"><i class="fa fa-map-marker" aria-hidden="true"></i> Cochin,
                            Kerala</a>
                        <a class="head-bar2" href="#"> <i class="fa fa-envelope"
                                aria-hidden="true"></i>contact@iimmcochin.org</a>
                        <a class="head-bar3" href="#"><i class="fa fa-phone" aria-hidden="true"></i> +91 94002 61874</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-3 col-4">
                    <div class="icons ms-auto ">
                        <div class="d-flex justify-content-end">
                            <a href="https://www.facebook.com/share/1JnuxounRs/" class="social-icon facebook"
                                target="_blank"><i class="fa fa-facebook"></i></a>
                            <a href="#" class="social-icon twitter"><i class="fa fa-x-twitter"></i></a>
                            <a href="https://www.instagram.com/iimmiancochin?igsh=MTd5ZTk4N3hscmRzcg=="
                                class="social-icon instagram" target="_blank"><i class="fa fa-instagram"></i> </a>
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link btn custom-btn d-none d-lg-block"
                                    href="{{ route('enquiry-form') }}">Enquire Now</a>
                            </li>
                        </ul>
                    </div>
                </nav>
    ...
    <section class="footer">
        <div class="container">
                ...
                <div class="col-xl-5 col-lg-5 align-self-center wow fadeIn">
                    <div class="newsletter">
                        <form action="#" method="post">
                            <input type="email" class="email-box" name="EMAIL" placeholder="Email Address">
            ...
            <div class="row footer-bottom">
                        ...
                        <div class="about-footer">
                            <div class="foot-color">
                                <div class="footer-logo">
                                    <a href="{{ route('home') }}"><img
                                            src="{{ asset('assets/img/logo/iimm-cochin.png') }}" alt="Edumon"></a>
                                </div>
                            </div>
                            <h5 class="fntitle">Get in touch with us</h5>
                            <p>
                                Indian Institute of Materials Management,
                                GCDA Shopping Complex, Kadavanthra PO, Cochin, Kerala<br>
                                India 682 020.
                            </p>
                            ...
                            <div class="fot-social">
                                ...
                                <ul class="social-link">
                                    <li>
                                        <a href="https://www.facebook.com/share/1JnuxounRs/" target="_blank"><i
                                                class="fa fa-facebook-square"></i></a>
                                    </li>

                                    <li>
                                        <a href="https://www.instagram.com/iimmiancochin?igsh=MTd5ZTk4N3hscmRzcg=="
                                            target="_blank"><i class="fa fa-instagram-square"></i></a>
                                    </li>
                                    <li>
                                        <a href="https://www.instagram.com/iimmiancochin?igsh=MTd5ZTk4N3hscmRzcg=="
                ...
                <div class="col-xl-2 col-md-6 col-12 wow fadeIn">
                    <div class="single-footer">
                        <h3 class="footer-title">Useful Links</h3>
                        <ul>
                            <li><a href="{{ route('about') }}">About Us</a></li>
                            <li><a href="{{ route('course') }}">Testimonials</a></li>
                            <li><a href="{{ route('event') }}">Courses</a></li>
                ...
                <div class="col-xl-2 col-md-6 col-12 wow fadeIn">
                    <div class="single-footer">
                        ...
                        <ul>
                            <li><a href="{{ route('past-chairman-says') }}">Past Chairmen Say</a></li>
                            <li><a href="{{ route('enquiry-form') }}">Enquire Now</a></li>
                    ...
                    <div class="single-footer">
                        ...
                        <div class="contact-info">
                            ...
                            <p>
                                ...
                                <span><a href="tel:+91 484 2203487">+91 484 2203487</a> <br>
                                    <a href="tel:+91 94002 61874">+91 94002 61874</a></span>
                            </p>

                            <p>
                                <i class='bx bx-envelope'></i>
                                <span>contact@iimmcochin.org<br>
                                    iimmcochin@gmail.com</span>
                            </p>
                        </div>
                    </div>
                </div><!-- End Col -->
        ...
        <div class="copyright text-center wow fadeIn">
            <p>Copyright @2025 <a href="https://eyednext.in">iimm.</a> All Rights Reserved </p>
        </div>
    </section>
    <!-- End Footer -->
    <!-- WhatsHelp.io widget -->
    <script type="text/javascript">
        (function () {
            var options = {
                whatsapp: "+91 94002 61874",
                call_to_action: "IIMM COCHIN Helps you",
                position: "right",
            };
