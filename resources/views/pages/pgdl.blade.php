...
@section('meta')
    <title>Post Graduate Diploma in Logistics & Supply Chain Management</title>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="description" content=" Enhance your career with IIMM’s Post Graduate Diploma in Logistics & Supply Chain Management. Gain industry-ready skills in operations, procurement, and global supply chain strategies." />
    <meta name="keywords" content=" Logistics, diploma in logistics, Supply Chain Management" />
    <meta property="og:locale" content="en_IN" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="PG Diploma in Logistics & Supply Chain Management | IIMM" />
    <meta property="og:url" content="PAGE_URL" />
    <meta property="og:site_name" content="Indobritco" />
    <meta property="og:image" content="#" />
    <meta property="og:image:width" content="1200" />
    <meta property="og:image:height" content="550" />
    <meta property="og:description" content="Join IIMM’s PG Diploma in Logistics & Supply Chain Management and prepare for a successful career in logistics, procurement, and supply chain management" />
		...
		<div class="container">
			<div class="row">
				<div class="col-xl-8 wow fadeIn">
					...
					<h2 class="long-course.php">PGDL & SCM (Post Graduate Diploma in Logistics & Supply Chain Management)
</h2>
					<div class="tab-content" id="nav-tabContent">
						<div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab" tabindex="0">
							<p>
							
The Post Graduate Diploma in Logistics & Supply Chain Management (PGDL&SCM) is a 2-year long-term program structured across four semesters, aimed at preparing graduates for dynamic careers in logistics, warehousing, procurement, and supply chain operations. Applicants must be graduates from a recognized university and are required to pass the All India IIMM Entrance Test for admission. The program concludes with a self-study project report and viva, helping students apply what they've learned in a practical setting.


							</p>
							<ul class="management">
                    			<h3>Semester 1</h3>
								<li>1.  Management principles & OB</li>
								<li>2. Business Communication</li>
		                        <li>3.  Business Economics</li>
		                        <li>4. Business Environment</li>
		                        <li>5.  Business Analytics</li>
                    		</ul>
                    		<ul class="management">
			                    <h3>Semester 2</h3>
		                        <li>1. Research Methodology</li>
		                        <li>2. Financial Accounting</li>
		                        <li>3. Supply Chain Management</li>
		                        <li>4. IT applications in Management</li>
		                        <li>5 .Operations Management</li>
			                </ul>
			                <ul class="management">
								<h3>Semester 3</h3>
		                         <li>1. Purchase Management</li>
		                         <li>2. Inventory Management</li>
		                         <li>3. Logistics & warehousing Management</li>
		                         <li>4. Legal Aspects in Business</li>
		                        <li>5 .International Trade</li>
			                    </ul>
			                <ul class="management">
								<h3>Semester 4</h3>
			                        <li>1. Strategic Management</li>
			                        <li>2. Packaging & Distribution Management</li>
			                        <li>3. Emerging Trends in Logistics & Supply Chain Management</li>
			                        <li>4. Elective</li>
			                        <li>5. World Class Manufacturing</li>
			                        <li>6. Entrepreneurship and New Ventures</li>
							</ul>
							...
							<div class="cd_instructor">
								...
								<div class="cdin_content">
									...
									<div class="cdin_meta">
										...
										<div class="cdin_meta_item"><i class='bx bxs-folder-open'></i>  Courses</div>
									</div>
								</div>
							</div>
						</div>
