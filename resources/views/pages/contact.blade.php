...
@section('content')
							...
							<div class="row">
								...
								<div class="col-xl-6">
									<input type="email" name="email" placeholder="Enter Email"
										class="form-control form-box1" required>
								</div>
								...
								<div class="col-xl-12">
									<input type="text" name="phone" placeholder="Enter Phone"
										class="form-control form-box1">
								</div>
								<div class="col-xl-12 col-12">
									<select class="form-control form-box1" name="subject">
								...
								<div class="col-12">
									<textarea name="message" placeholder="Enter Message"
										class="form-control form-t form-box1"></textarea>
								</div>
	...
	<section class="google_map">
		<iframe
			src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3929.595846046741!2d76.2983679!3d9.967543899999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x98f7701607a4275%3A0xddc257dcd2e69dc2!2sIIMM%20COCHIN!5e0!3m2!1sen!2sin!4v1757542642628!5m2!1sen!2sin"
