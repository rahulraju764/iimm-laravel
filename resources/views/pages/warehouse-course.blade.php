		...
		<div class="container">
			<div class="row">
				<div class="col-xl-8 wow fadeIn">
					...
					<h2 class="scourse-title">   ADVANCED STORES & WAREHOUSE MANAGEMENT
</h2>
					<div class="tab-content" id="nav-tabContent">
						<div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab" tabindex="0">
							<p>
								Advanced Stores & Warehouse Management is a short-term course that covers how to efficiently manage store and warehouse operations. It includes topics like organizing store functions, designing storage spaces, and using systems to track inventory. The course also explains how to store and preserve goods properly, manage stock levels, and ensure safety and compliance. It includes how to prepare store performance reports , handle waste, and manage packaging and distribution. This course helps professionals improve efficiency, reduce losses, and maintain smooth warehouse operations using modern tools and best practices.
							...
							<ul class="logicstic">
						<li>1. Principles of Stores Management

						</li>
						<li>2. Organisation of Stores Management

						</li>
						<li>3. Stores Architecture & Designing

						</li>
						<li>4. Stores System for Track and Trace

						</li>
						<li>5. Storage & Preservation

						</li>
						<li>6. Stock Accounting & Inventory Control

						</li>
						<li>7. Handling Safety & Compliance in Store

						</li>
						<li>8 .Stores Reporting & Performance Tools

						</li>
						<li>9 .Waste Management & Disposal

						</li>
						<li>10 .Packaging & Distribution Management
				...
				<div class="col-xl-4 wow fadeIn">
					<div class="course-sidebar">
						...
						<ul class="scourse_list">
							...
							<li>
								<span class="cside-label">
									<i class="fa-regular fa-file"></i> Module
								</span>
