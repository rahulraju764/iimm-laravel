			...
			<div class="row">
				<div class="col-xl-8 wow fadeIn">
					<div class="scourse_image">
						<img src="{{ asset('assets/img/course-details/SAP.webp') }}" alt="image">
						
					</div>

					<h2 class="scourse-title">SAP CERTIFICATIONS
</h2>
					<div class="tab-content" id="nav-tabContent">
						<div class="tab-pane fade show active" id="nav-overview" role="tabpanel" aria-labelledby="nav-overview-tab" tabindex="0">
							<p>
								SAP is an advanced enterprise resource planning system designed to simplify and integrate core business operations. It connects finance, HR, sales, procurement, and supply chain processes into one unified platform, ensuring smooth data flow and improved accuracy. With real-time insights, SAP helps businesses make faster, smarter decisions while reducing manual work and operational errors. Its automation features enhance productivity, and its strong security framework protects sensitive information. SAP is highly scalable, customizable, and suitable for industries of all sizes, empowering organizations to work efficiently and achieve consistent growth.

							</p>
							<ul class="logicstic">
						<li>1. SAP streamlines business processes across all departments

						</li>
						<li>2. It integrates finance, sales, HR, and operations in one system.


						</li>
						<li>3. Real-time data helps companies make faster decisions.


						</li>
						<li>4. SAP improves workflow efficiency and reduces manual errors.


						</li>
						<li>5. It supports automation for repetitive business tasks.
